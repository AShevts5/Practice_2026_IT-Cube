export interface paths {
    ...
    "/public/ai-chat/sessions": {
        ...
        get?: never;
        put?: never;
        post: operations["startAiChatSession"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/public/ai-chat/sessions/{session_id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: operations["getAiChatSession"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/public/ai-chat/sessions/{session_id}/messages": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
...
export interface components {
    schemas: {
        ...
        AiChatSessionResponse: {
            session: components["schemas"]["AiChatSession"];
        ...
        AiChatSendMessageResponse: {
            user_message: components["schemas"]["AiChatMessage"];
            assistant_message: components["schemas"]["AiChatMessage"];
        };
    };
    responses: never;
    parameters: never;
...
export interface operations {
    ...
    startAiChatSession: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["AiChatSessionCreateRequest"];
            };
        };
        responses: {
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["AiChatSessionResponse"];
                };
            };
        };
    };
    ...
    sendAiChatMessage: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["AiChatSendMessageRequest"];
            };
        };
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AiChatSendMessageResponse"];
                };
            };
        };
    };
